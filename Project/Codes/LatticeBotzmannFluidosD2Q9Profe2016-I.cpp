...
public:
  ...
  void Inicie(void);
  double Rho1(int ix,int iy,int t,bool CalculeConNew);
  double Rho2(int ix,int iy,int t,bool CalculeConNew);
  double Ux1(int ix,int iy,int t,bool CalculeConNew);
  double Ux2(int ix,int iy,int t,bool CalculeConNew);
  double Uy1(int ix,int iy,int t,bool CalculeConNew);
  double Uy2(int ix,int iy,int t,bool CalculeConNew);
  double feq1(double Rho0,double Ux0,double Uy0,int i);
  double feq2(double Rho0,double Ux0,double Uy0,int i);
  void Colisione1(int t);
  void Colisione2(int t);
  void Adveccione1(void);
  void Adveccione2(void);
